...
const TimeEventSchema = new mongoose.Schema(
  {
    ...
    source: {
      type: String,
      enum: ["", "manual", "measured", "measured_capped", "estimated"],
      default: "",
    },
    restType: {
      type: String,
      enum: ["", "between_sets", "between_exercises"],
      default: "",
    },
    workSeconds: { type: Number, min: 0, max: 600, default: null },
  },
  { _id: false },
);
...
const ExerciseDurationSchema = new mongoose.Schema(
  {
    ...
    preparationSeconds: { type: Number, default: null },
...
const TrainingSchema = new mongoose.Schema(
  {
    ...
    preparationSeconds: { type: Number, min: 0, default: null },
